		...
		<div class="news">
			...
			<div class="blocks">
				...
				<div class="card">
					...
					<a class="btn" href="/Detail.php?id=<?=$row['id']?>"><button class="card-button"><p class="card-button-text"> ПОДРОБНЕЕ </p> <i class="fa-solid fa-arrow-right-long fa-2xl"></i></button></a>
				</div>
				<?php 
				}
				?>
